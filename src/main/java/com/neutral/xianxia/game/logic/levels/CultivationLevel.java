...
public enum CultivationLevel {
    ...
    LESSER_ANCESTOR_REALM("Lesser Ancestor", 55, 56, 57, 58, 59, 60, 61, 62, 63),
    GREATER_ANCESTOR_REALM("Greater Ancestor", 64, 65, 66, 67, 68, 69, 70, 71, 72),
    ETERNAL_ANCESTOR_REALM("Eternal Ancestor", 73, 74, 75, 76, 77, 78, 79, 80, 81);
